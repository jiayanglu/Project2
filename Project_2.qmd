...
knitr::kable(outcomes_animal_2013_to_2022, 
             caption= name,
             digits=2)
...
Based on the "Type of Report" numerical summaries, the distributions of percentage seem very different among types of reports. Let’s visualize the distributions with box plots.

```{r}

plot1 <- ggplot(type_of_report_animal_2013_to_2022, 
                aes(reaction,
                    percentage,
                    color=reaction)) +
  ...
  # Add a title.
  ggtitle("Percentage of Types of Adverse Events from 20130101 to 20221231") + 
